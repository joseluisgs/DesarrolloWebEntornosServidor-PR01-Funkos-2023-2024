...
public class DatabaseManager implements AutoCloseable {
    ...
    private String databaseUrl = "jdbc:h2:C:/Users/elkas/Trabajos_EnServidor/ElKasmiMohamed/Funkos"; // Fichero de configuración se lee en el constructor
    ...
    private void loadProperties() {
        ...
        try {
            ...
            databaseUrl = props.getProperty("database.url", "C:/Users/elkas/Trabajos_EnServidor/ElKasmiMohamed/Funkos.mv.db");
    ...
    public static void main(String[] args) {
        ...
        try {
            db.executeScript("init.sql", true);
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
